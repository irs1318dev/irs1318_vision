...
public class VisionConstants
{
    ...
    public static final Scalar HSV_FILTER_LOW = new Scalar(22, 85, 145);// original values: new Scalar(90, 255, 255);
    public static final Scalar HSV_FILTER_HIGH = new Scalar(31, 198, 252);// original values: new Scalar(90, 255, 255);
